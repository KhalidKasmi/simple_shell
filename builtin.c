...
/**
 * _mycd - alters the present working directory of the process
 * @inf: Structure holding possible arguments. Utilized to keep
 ...
 * @inf: Structure containing potential arguments. Employed to preserve
 * constant function prototype.
 * Return: Always 0
 */
